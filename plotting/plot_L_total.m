...
flag_iqr = 1; % 1 plot IQR, 0: plot envelope
...
%% Subplot 1: lake levels following historical HPP
subplot(3,1,1)

% load 
if flag_bc == 1 % QUANT 
    load L_rcp85_HPP_hist_QUANT.mat 
    load L_rcp45_HPP_hist_QUANT.mat
    load L_rcp26_HPP_hist_QUANT.mat 
    title_large = 'Empirical quantiles';
elseif flag_bc ==2 % PFT
    load L_rcp85_HPP_hist_PFT.mat 
    load L_rcp45_HPP_hist_PFT.mat 
    load L_rcp26_HPP_hist_PFT.mat 
...
% calculate
L_rcp26_diff = L_tot_rcp26(length(L_tot_rcp26)) - L_tot_hist(length(L_hist))
L_rcp45_diff = L_tot_rcp45(length(L_tot_rcp26)) - L_tot_hist(length(L_hist))
L_rcp85_diff = L_tot_rcp85(length(L_tot_rcp26)) - L_tot_hist(length(L_hist))
...
diff_rcp26 = max_L_rcp26_tot(length(min_L_rcp45_tot)) - min_L_rcp26_tot(length(min_L_rcp45_tot))
diff_rcp45 = max_L_rcp45_tot(length(min_L_rcp45_tot)) - min_L_rcp45_tot(length(min_L_rcp45_tot))
diff_rcp85 = max_L_rcp85_tot(length(min_L_rcp45_tot)) - min_L_rcp85_tot(length(min_L_rcp45_tot))

rise = max_L_rcp85_tot(length(min_L_rcp45_tot)) - L_tot_hist(length(L_hist))
drop = L_tot_hist(length(L_hist)) - min_L_rcp85_tot(length(min_L_rcp85_tot))
...
% plot means
 ...
 title('Historical hydropower scenario','Fontsize', title_size, 'Fontweight', 'Bold', 'color', axcolor)
...
%% Subplot 2: lake levels following maximum HPP
subplot(3,1,2)

% load 
if flag_bc == 1 % QUANT 
    load L_rcp85_HPP_max_QUANT.mat
    load L_rcp45_HPP_max_QUANT.mat
    load L_rcp26_HPP_max_QUANT.mat  
elseif flag_bc ==2 % PFT
    load L_rcp85_HPP_max_PFT.mat 
    load L_rcp45_HPP_max_PFT.mat 
    load L_rcp26_HPP_max_PFT.mat 
end
...
%   set(legend,'Fontweight', 'Bold', 'Fontsize',legend_size, 'TextColor', axcolor,'Location','southwest');
 title('High hydropower scenario','Fontsize', title_size, 'Fontweight', 'Bold', 'color', axcolor)
 set(gca, 'Fontsize', label_size, 'Fontweight', 'Bold','Xcolor', axcolor,...
   'Ycolor', axcolor,'xtick',[year_loc],'xticklabel',labels,'xticklabelrotation',45); 
ylabel('Lake level (m a.s.l.)','Fontsize', ylabel_size, 'Fontweight', 'Bold', 'color', axcolor)
grid on
...
diff_rcp26 = max_L_rcp26_tot(length(min_L_rcp45_tot)) - min_L_rcp26_tot(length(min_L_rcp45_tot))
diff_rcp45 = max_L_rcp45_tot(length(min_L_rcp45_tot)) - min_L_rcp45_tot(length(min_L_rcp45_tot))
diff_rcp85 = max(max_L_rcp85_tot() - min_L_rcp85_tot())
