...
for (i in 1:nm){
  ...
  qm.fit <- fitQmapPTF(obs, mod, transfun=c("linear"), wet.day=TRUE,
                       cost=c("RSS","MAE"), qstep=0.001)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/P_wb_histobs_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/E_wb_histobs_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/Qin_wb_histobs_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/P_wb_hist_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/E_wb_hist_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/Qin_wb_hist_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/P_wb_rcp26_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/E_wb_rcp26_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/Qin_wb_rcp26_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/P_wb_rcp45_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/E_wb_rcp45_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/Qin_wb_rcp45_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/P_wb_rcp85_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/E_wb_rcp85_bc.csv",row.names=FALSE,col.names=NULL)
...
# wite bc data to csv
write.csv(bcdata, file = "PFT_lin/Qin_wb_rcp85_bc.csv",row.names=FALSE,col.names=NULL)
